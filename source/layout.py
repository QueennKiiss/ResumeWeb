"""
Module containing all the methods to implement the resume web layout
"""
...
def professional_page_content() -> html.Div:
    """ Implement professional page content"""
    return html.Div(
        id="professional",
        className="page_container",
        children=[
            html.H1("Professional Background"),
            html.Div(
                className="prof_content_container",
                children=[
                    dbc.Row([
                        dbc.Col(html.H3("Nanopohtonics"), width=2),
                        dbc.Col(html.H3("Doctorate"), width=4),
                        dbc.Col(),
                        dbc.Col(),
                        dbc.Col(),
                        dbc.Col(html.H3("Post-doctorate")),
                        dbc.Col(),
                        dbc.Col(),
                        dbc.Col(html.H3("Post-doctorate")),
                        dbc.Col(html.H3("Circontrol")),
                        dbc.Col(),
                        ]),
                    dbc.Row([
                        dbc.Col(html.H5("2010")),
                        dbc.Col(html.H5("2011")),
                        dbc.Col(html.H5("2012")),
                        dbc.Col(html.H5("2013")),
                        dbc.Col(html.H5("2014")),
...
def educational_page_content(app: Dash) -> html.Div:
    ...
    doctorate = _card_content(
        '2017',
        'Electronic engineering and telecommunication Ph.D.',
        "Universidad autonoma de Barcelona", "2013-2017",
        image=images.UAB_LOGO
        )
    master_elect = _card_content(
        "2013",
        "Master in micro and nanoelectronics",
    ...
    master_phys = _card_content(
        "2012",
        "Master in Physics instrumentation",
        "Universidad de Valladolid",
        "2011-2012",
        image=images.UVA_LOGO
        )
    grade = _card_content(
        "2009",
        "Bachelor in Physics",
    ...
    return html.Div(
        id="educational_page",
        className="page_container",
        children=[html.H1("Educational Background"), cards, ]
        )


def skills_page_content() -> html.Div:
    """ Implement skills page content"""
    return html.Div(
        id="skills_page",
        className="page_container",
        children=[html.H1("Skills"), ]
        )


def create_contact_field(app: Dash, icon: images, field_text: str) -> html.Div:
    """ Create contact field content"""
    return html.Div(
        className="contact_field",
        children=[
            html.Img(className="contact_icon", src=app.get_asset_url(icon), ),
            html.P(field_text),
            ]
        )
...
def contact_page_content(app: Dash) -> html.Div:
    """ Implement content page content"""
    return html.Div(
        id="contact_page",
        className="page_container",
        children=[
            html.H1("Contact"),
            create_contact_field(app, images.CONTACT_ICON, "679 156 142"),
            ...
            create_contact_field(app, images.GITHUB_ICON, "https://github.com/QueennKiiss"),
...
def content_bar(app: Dash) -> html.Div:
    ...
    div = html.Div(
        ...
        children=[
            # professional_page_content(),
            about_page_content(),
            # educational_page_content(),
            # skills_page_content(),
...
def sidebar(app: Dash) -> html.Div:
    ...
    div = html.Div(
        ...
        children=[
            html.Img(
                className="profile_photo image",
                src=app.get_asset_url(images.USER_PROFILE), ),
            dbc.Nav([
                dbc.NavItem(
                    id="navitem_about",
                    ...
                    children=dbc.NavLink(
                        id="link_about",
                        className="navlink_text about",
                        children=html.H4("About me", className="text"),
                        href="#about_page",
                        external_link=True, n_clicks=0,
                        )
                    ),
                dbc.NavItem(
                    id="navitem_professional",
                    className="navitem professional",
                    style={},
                    children=dbc.NavLink(
                        id="link_professional",
                        className="navlink_text professional",
                        children=html.H4("Professional", className="text"),
                        active="exact",
                        href="#professional_page",
                        external_link=True,
                        n_clicks=0
                        ),
                    ),
                dbc.NavItem(
                    id="navitem_educational",
                    className="navitem educational",
                    children=dbc.NavLink(
                        id="link_educational",
                        className="navlink_text educational",
                        children=html.H4("Educational", className="text"),
                        href="#educational_page",
                        external_link=True,
                        n_clicks=0
                        )
                    ),
                dbc.NavItem(
                    ...
                    children=dbc.NavLink(
                        id="link_skills",
                        className="navlink_text skills",
                        children=html.H4("Skills", className="text"),
                        href="#skills_page",
                        external_link=True,
                        n_clicks=0
                        )
                ...
                dbc.NavItem(
                    ...
                    children=dbc.NavLink(
                        id="link_contact",
                        className="navlink_text contact",
                        children=html.H4("Contact", className="text"),
                        href="#contact_page",
                        external_link=True,
                        n_clicks=0,
                        )
...
def resume_content(app: Dash) -> html.Div:
    ...
    return html.Div(
        className="resume_content_container",
        children=[sidebar(app), content_bar(app)]
        )


def cover_page(app: Dash) -> html.Div:
    """ Implement cover page content"""
    return html.Div(
        className="cover_page_container",
        children=[
            html.Div(
                className="cover_page_section_left",
                children=[
                    html.Div(
                        [
                            html.H3("Hi there"),
                            html.H1("I'M MARCOS"),
                            html.H5("SOFTWARE ENGINEER"),
                            dcc.Markdown(
                                '''
                                 I am a technology enthusiast and motivated physicist/electronic
                                 engineer looking for a professional career change.
                    ...
                    html.Div(
                        html.Button(
                            id='view_resume button',
                            className='view_resume_button',
            ...
            html.Div(
                className="cover_page_section right",
                children=[
                    html.Img(
                        className="cover_profile_photo image",
                        # src=app.get_asset_url(images.USER_PROFILE),
